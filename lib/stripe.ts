...
// LOGIC: Check for LIVE key first, then TEST key.
// @ts-ignore
const STRIPE_KEY = env.VITE_STRIPE_LIVE_PUBLISHABLE_KEY || env.VITE_STRIPE_TEST_PUBLISHABLE_KEY || env.VITE_STRIPE_PUBLISHABLE_KEY;
