  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4 z-[9999] relative">
      ...
      <div className="text-center">
        <h2 className="text-white font-shrikhand text-4xl tracking-widest uppercase animate-pulse">
            {text}
        </h2>
        {subText && (
            <p className="text-zinc-500 font-shrikhand text-lg uppercase tracking-wide mt-2">
                {subText}
            </p>
        )}
      </div>
