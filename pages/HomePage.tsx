...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center sm:px-6 lg:px-8 overflow-visible">
          ...
          <div className="mt-12 flex justify-center gap-6">
            <a 
              href="#packages"
              className="group relative bg-co-yellow text-black px-12 py-4 font-kanit text-xl font-semibold uppercase tracking-wide hover:bg-white transition-all duration-300 -skew-x-12 shadow-[0_0_20px_rgba(255,215,0,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.4)]"
            >
              <span className="skew-x-12 inline-block">Book a Free Class</span>
            </a>
          </div>
        </div>
        
        {/* Decorative elements */}
        <div className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-black via-co-tan to-co-yellow"></div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            <div className="relative group">
              ...
              <div className="absolute -inset-4 bg-co-yellow/20 rounded-lg transform -rotate-2 group-hover:-rotate-1 transition-transform duration-500"></div>
              <img 
      ...
      <section id="packages" className="py-32 bg-dark-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <div className="inline-block mt-4 bg-gradient-to-r from-emerald-600 to-green-500 text-white text-lg px-6 py-2 rounded font-kanit font-bold tracking-wide shadow-[0_0_20px_rgba(16,185,129,0.3)]">
              ★ New athletes get 6 FREE trial sessions — no payment required!
            </div>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-24 bg-co-yellow relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          <Link 
            to="/login" 
            className="group relative inline-block bg-black text-white px-16 py-5 font-shrikhand text-3xl uppercase font-medium hover:bg-white hover:text-black shadow-[0_10px_30px_rgba(0,0,0,0.3)] hover:shadow-[0_10px_40px_rgba(0,0,0,0.5)] transition-all duration-300 transform -skew-x-12"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-zinc-900 border border-zinc-800 p-10 rounded-sm relative overflow-hidden group">
              ...
              <div className="flex items-center gap-4 mb-6 relative z-10">
                ...
                <h3 className="font-shrikhand text-3xl text-white uppercase">Sibling Discounts</h3>
              </div>
              <p className="text-zinc-400 mb-6 font-kanit">Building a legacy? We support athletic families with significant discounts for multi-athlete households.</p>
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-10 rounded-sm relative overflow-hidden group">
              ...
              <div className="flex items-center gap-4 mb-6 relative z-10">
                <Heart className="text-co-yellow" size={32} />
                <h3 className="font-shrikhand text-3xl text-white uppercase">Community Support</h3>
              </div>
              <p className="text-zinc-400 mb-8 font-kanit">Every kid deserves a chance to compete. Donate to sponsor an athlete who needs financial assistance.</p>
              
              <div className="flex flex-col gap-4 relative z-10">
                <button 
                    onClick={() => setShowDonateModal(true)}
                    className="w-full bg-zinc-800 hover:bg-white hover:text-black text-white py-4 px-4 text-sm uppercase font-kanit font-medium tracking-widest transition-colors duration-300 flex items-center justify-center gap-2"
                >
                  <DollarSign size={16} /> Donate
                </button>
                <button 
                    onClick={() => navigate('/sponsor')}
                    className="w-full border border-zinc-700 text-zinc-400 hover:border-co-yellow hover:text-co-yellow py-4 px-4 text-sm uppercase font-kanit font-medium tracking-widest transition-colors duration-300"
                >
                  Sponsor an Athlete
                </button>
              </div>
      ...
      {showDonateModal && (
        ...
        >
            ...
            >
                ...
                <h2 className="font-shrikhand text-4xl text-white uppercase mb-2 flex items-center gap-2">
                    <Heart className="text-co-yellow" /> Support The Team
                </h2>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                    {[10, 25, 50, 100].map(amt => (
                        <button
                            ...
                            className={`py-4 border rounded font-shrikhand text-2xl transition-all ${donationAmount === amt ? 'bg-co-yellow border-co-yellow text-black' : 'bg-black border-zinc-800 text-zinc-400 hover:border-zinc-500'}`}
                        >
                            ${amt}
                        </button>
                    ))}
                ...
                <div className="mb-6 relative">
                    ...
                    <input 
                        ...
                        className="w-full bg-black border border-zinc-700 rounded p-4 pl-8 text-white focus:border-co-yellow outline-none font-shrikhand text-xl tracking-wide"
                    />
                </div>
                ...
                <button 
                    ...
                    className="w-full bg-white hover:bg-zinc-200 text-black font-shrikhand text-2xl uppercase py-4 rounded disabled:opacity-50 transition-colors"
                >
